function [power] = trialPower_whole(EEG,rawdata,lower_bound,upper_bound)
plotOn =0;
% lower_bound = 0.5;
% upper_bound = 30;
...
fftlength = 64;
srate = EEG.srate;
power = meanSpectrum( hilberted_data, winlength,overlap,fftlength,srate,lower_bound,upper_bound );
